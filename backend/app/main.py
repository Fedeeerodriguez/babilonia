...
from app.routers import auth, users, dashboard, metrics, conversations, documents, agent, tomi, analytics, feedback, health, higiene, tomi_control
...
for r in [auth, users, dashboard, metrics, conversations, documents, agent, tomi, analytics, feedback, health, higiene, tomi_control]:
